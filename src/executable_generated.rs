...
pub mod platforms {
    ...
    pub mod darwinn {
        ...
        pub const ENUM_VALUES_POSITION: [Position; 2] =
            [Position::LOWER_32BIT, Position::UPPER_32BIT];
        ...
        impl Position {
            ...
            pub const ENUM_VALUES: &'static [Self] = &[Self::LOWER_32BIT, Self::UPPER_32BIT];
            /// Returns the variant's name or "" if unknown.
            pub fn variant_name(self) -> Option<&'static str> {
                match self {
        ...
        #[allow(non_camel_case_types)]
        pub const ENUM_VALUES_DIRECTION: [Direction; 2] = [Direction::INFEED, Direction::OUTFEED];
        ...
        impl Direction {
            ...
            pub const ENUM_MIN: i16 = 0;
            pub const ENUM_MAX: i16 = 1;
            pub const ENUM_VALUES: &'static [Self] = &[Self::INFEED, Self::OUTFEED];
            /// Returns the variant's name or "" if unknown.
            pub fn variant_name(self) -> Option<&'static str> {
                match self {
        ...
        pub const ENUM_VALUES_ANY_LAYER: [AnyLayer; 3] =
            [AnyLayer::NONE, AnyLayer::OutputLayer, AnyLayer::InputLayer];
        ...
        impl AnyLayer {
            ...
            pub const ENUM_VALUES: &'static [Self] =
                &[Self::NONE, Self::OutputLayer, Self::InputLayer];
            /// Returns the variant's name or "" if unknown.
            pub fn variant_name(self) -> Option<&'static str> {
                match self {
                    Self::NONE => Some("NONE"),
        ...
        impl<'a> Meta<'a> {
            ...
            pub fn desc(&self) -> Description {
                ...
                unsafe {
                    self._tab
                        .get::<Description>(
                            Meta::VT_DESC,
                            Some(Description::BASE_ADDRESS_OUTPUT_ACTIVATION),
                        )
                        .unwrap()
                }
            }
            ...
            pub fn name(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<&str>>(Meta::VT_NAME, None)
                }
            }
            #[inline]
            pub fn position(&self) -> Position {
                ...
                unsafe {
                    self._tab
                        .get::<Position>(Meta::VT_POSITION, Some(Position::LOWER_32BIT))
                        .unwrap()
                }
            }
        }
        ...
        pub struct MetaBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
            fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
        }
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> MetaBuilder<'a, 'b, A> {
            #[inline]
            ...
            pub fn add_name(&mut self, name: ::flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<_>>(Meta::VT_NAME, name);
            }
            #[inline]
            pub fn add_position(&mut self, position: Position) {
                self.fbb_
                    .push_slot::<Position>(Meta::VT_POSITION, position, Position::LOWER_32BIT);
            }
            #[inline]
            pub fn new(
        ...
        impl<'a> FieldOffset<'a> {
            ...
            pub fn meta(&self) -> Option<Meta<'a>> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<Meta>>(FieldOffset::VT_META, None)
                }
            }
            #[inline]
            pub fn offset_bit(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(FieldOffset::VT_OFFSET_BIT, Some(0))
                        .unwrap()
                }
            }
        }
        ...
        impl ::flatbuffers::Verifiable for FieldOffset<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    .visit_field::<::flatbuffers::ForwardsUOffset<Meta>>(
                        "meta",
                        Self::VT_META,
                        false,
                    )?
        ...
        pub struct FieldOffsetBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
            fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
        }
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> FieldOffsetBuilder<'a, 'b, A> {
            #[inline]
            pub fn add_meta(&mut self, meta: ::flatbuffers::WIPOffset<Meta<'b>>) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<Meta>>(FieldOffset::VT_META, meta);
            }
            #[inline]
            pub fn add_offset_bit(&mut self, offset_bit: i32) {
                self.fbb_
                    .push_slot::<i32>(FieldOffset::VT_OFFSET_BIT, offset_bit, 0);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            ) -> FieldOffsetBuilder<'a, 'b, A> {
                let start = _fbb.start_table();
                FieldOffsetBuilder {
                    fbb_: _fbb,
                    start_: start,
        ...
        impl<'a> InstructionBitstream<'a> {
            ...
            >(
                ...
                if let Some(x) = args.field_offsets {
                    builder.add_field_offsets(x);
                }
                if let Some(x) = args.bitstream {
                    builder.add_bitstream(x);
                }
                builder.finish()
            }
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u8>>>(
                            InstructionBitstream::VT_BITSTREAM,
                            None,
                        )
                }
            }
            ...
            pub fn field_offsets(
                &self,
            ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<FieldOffset<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<FieldOffset>>,
                    >>(InstructionBitstream::VT_FIELD_OFFSETS, None)
                }
            }
        }
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    ...
                    .visit_field::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<FieldOffset>>,
                    >>("field_offsets", Self::VT_FIELD_OFFSETS, false)?
                    .finish();
                Ok(())
            }
        }
        pub struct InstructionBitstreamArgs<'a> {
            ...
            pub field_offsets: Option<
                ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<FieldOffset<'a>>>,
                >,
            >,
        }
        ...
        pub struct InstructionBitstreamBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
            fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
        }
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> InstructionBitstreamBuilder<'a, 'b, A> {
            #[inline]
            pub fn add_bitstream(
                &mut self,
                bitstream: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, u8>>,
            ) {
            ...
            #[inline]
            pub fn add_field_offsets(
                &mut self,
                field_offsets: ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<FieldOffset<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    InstructionBitstream::VT_FIELD_OFFSETS,
                    field_offsets,
                );
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            ) -> InstructionBitstreamBuilder<'a, 'b, A> {
                let start = _fbb.start_table();
        ...
        impl<'a> DmaDescriptorHint<'a> {
            ...
            pub fn meta(&self) -> Option<Meta<'a>> {
                ...
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<::flatbuffers::ForwardsUOffset<Meta>>(
                        DmaDescriptorHint::VT_META,
                        None,
                    )
                }
            }
            ...
            pub fn offset_in_bytes(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(DmaDescriptorHint::VT_OFFSET_IN_BYTES, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn size_in_bytes(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(DmaDescriptorHint::VT_SIZE_IN_BYTES, Some(0))
                        .unwrap()
                }
            }
        }
        ...
        pub struct DmaDescriptorHintBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
            fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
        }
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> DmaDescriptorHintBuilder<'a, 'b, A> {
            #[inline]
            pub fn add_meta(&mut self, meta: ::flatbuffers::WIPOffset<Meta<'b>>) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<Meta>>(
                        DmaDescriptorHint::VT_META,
                        meta,
                    );
            }
            ...
            pub fn add_offset_in_bytes(&mut self, offset_in_bytes: i32) {
                self.fbb_.push_slot::<i32>(
                    DmaDescriptorHint::VT_OFFSET_IN_BYTES,
                    offset_in_bytes,
                    0,
                );
            }
            ...
            pub fn add_size_in_bytes(&mut self, size_in_bytes: i32) {
                self.fbb_
                    .push_slot::<i32>(DmaDescriptorHint::VT_SIZE_IN_BYTES, size_in_bytes, 0);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            ) -> DmaDescriptorHintBuilder<'a, 'b, A> {
                let start = _fbb.start_table();
        ...
        impl<'a> InterruptHint<'a> {
            ...
            pub fn type_(&self) -> InterruptType {
                ...
                unsafe {
                    self._tab
                        .get::<InterruptType>(
                            InterruptHint::VT_TYPE_,
                            Some(InterruptType::SCALAR_CORE_INT_0),
                        )
                        .unwrap()
                }
            }
        ...
        pub struct InterruptHintBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
            fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
        }
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> InterruptHintBuilder<'a, 'b, A> {
            #[inline]
            pub fn add_type_(&mut self, type_: InterruptType) {
                self.fbb_.push_slot::<InterruptType>(
                    InterruptHint::VT_TYPE_,
                    type_,
                    InterruptType::SCALAR_CORE_INT_0,
                );
        ...
        impl<'a> InstructionHint<'a> {
            ...
            pub fn instruction_chunk_index(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(InstructionHint::VT_INSTRUCTION_CHUNK_INDEX, Some(0))
                        .unwrap()
                }
            }
        }
        ...
        impl ::flatbuffers::Verifiable for InstructionHint<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    .visit_field::<i32>(
                        "instruction_chunk_index",
                        Self::VT_INSTRUCTION_CHUNK_INDEX,
                        false,
                    )?
                    .finish();
                Ok(())
        ...
        pub struct InstructionHintBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
            fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
        }
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> InstructionHintBuilder<'a, 'b, A> {
            #[inline]
            pub fn add_instruction_chunk_index(&mut self, instruction_chunk_index: i32) {
                self.fbb_.push_slot::<i32>(
                    InstructionHint::VT_INSTRUCTION_CHUNK_INDEX,
                    instruction_chunk_index,
                    0,
                );
            }
        ...
        pub struct FenceHintBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
            fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
        }
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> FenceHintBuilder<'a, 'b, A> {
            #[inline]
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            ) -> FenceHintBuilder<'a, 'b, A> {
                let start = _fbb.start_table();
                FenceHintBuilder {
                    fbb_: _fbb,
                    start_: start,
        ...
        impl<'a> DmaHint<'a> {
            ...
            >(
                ...
                if let Some(x) = args.any_hint {
                    builder.add_any_hint(x);
                }
            ...
            pub fn any_hint_type(&self) -> AnyHint {
                ...
                unsafe {
                    self._tab
                        .get::<AnyHint>(DmaHint::VT_ANY_HINT_TYPE, Some(AnyHint::NONE))
                        .unwrap()
                }
            }
            #[inline]
            ...
            pub fn direction(&self) -> Direction {
                ...
                unsafe {
                    self._tab
                        .get::<Direction>(DmaHint::VT_DIRECTION, Some(Direction::INFEED))
                        .unwrap()
                }
            }
            #[inline]
     ...
     .finish();
        ...
        pub struct DmaHintBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
            fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
        }
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> DmaHintBuilder<'a, 'b, A> {
            #[inline]
            pub fn add_any_hint_type(&mut self, any_hint_type: AnyHint) {
                self.fbb_.push_slot::<AnyHint>(
                    DmaHint::VT_ANY_HINT_TYPE,
                    any_hint_type,
                    AnyHint::NONE,
                );
            }
            ...
            pub fn add_any_hint(
                &mut self,
                any_hint: ::flatbuffers::WIPOffset<::flatbuffers::UnionWIPOffset>,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    DmaHint::VT_ANY_HINT,
                    any_hint,
        ...
        impl<'a> DmaHints<'a> {
            ...
            pub fn hints(
                &self,
            ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<DmaHint<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<DmaHint>>,
                    >>(DmaHints::VT_HINTS, None)
                }
            }
            #[inline]
            pub fn fully_deterministic(&self) -> bool {
                ...
                unsafe {
                    self._tab
                        .get::<bool>(DmaHints::VT_FULLY_DETERMINISTIC, Some(false))
                        .unwrap()
                }
            }
        }
        ...
        impl ::flatbuffers::Verifiable for DmaHints<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    .visit_field::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<DmaHint>>,
                    >>("hints", Self::VT_HINTS, false)?
                    .visit_field::<bool>(
                        "fully_deterministic",
                        Self::VT_FULLY_DETERMINISTIC,
                        false,
                    )?
                    .finish();
                Ok(())
        ...
        pub struct DmaHintsArgs<'a> {
            pub hints: Option<
                ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<DmaHint<'a>>>,
                >,
            >,
        ...
        pub struct DmaHintsBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
            fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
        }
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> DmaHintsBuilder<'a, 'b, A> {
            #[inline]
            pub fn add_hints(
                &mut self,
                hints: ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<DmaHint<'b>>>,
                >,
            ) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<_>>(DmaHints::VT_HINTS, hints);
            }
            #[inline]
            pub fn add_fully_deterministic(&mut self, fully_deterministic: bool) {
                self.fbb_.push_slot::<bool>(
                    DmaHints::VT_FULLY_DETERMINISTIC,
                    fully_deterministic,
                    false,
                );
            }
        ...
        impl<'a> OutputLayout<'a> {
            ...
            >(
                ...
                if let Some(x) = args.x_coordinate_to_local_y_row_size {
                    builder.add_x_coordinate_to_local_y_row_size(x);
                }
                if let Some(x) = args.y_coordinate_to_local_y_offset {
                    builder.add_y_coordinate_to_local_y_offset(x);
                }
                if let Some(x) = args.x_coordinate_to_local_byte_offset {
                    builder.add_x_coordinate_to_local_byte_offset(x);
                }
                if let Some(x) = args.linearized_tile_byte_offset {
                    builder.add_linearized_tile_byte_offset(x);
                }
                if let Some(x) = args.x_coordinate_to_linear_tile_id_map {
                    builder.add_x_coordinate_to_linear_tile_id_map(x);
                }
                if let Some(x) = args.y_coordinate_to_linear_tile_id_map {
                    builder.add_y_coordinate_to_linear_tile_id_map(x);
                }
                builder.finish()
            }
            ...
            pub fn y_coordinate_to_linear_tile_id_map(
                &self,
            ) -> Option<::flatbuffers::Vector<'a, i32>> {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, i32>>>(
                            OutputLayout::VT_Y_COORDINATE_TO_LINEAR_TILE_ID_MAP,
                            None,
                        )
                }
            }
            ...
            pub fn x_coordinate_to_linear_tile_id_map(
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, i32>>>(
                            OutputLayout::VT_X_COORDINATE_TO_LINEAR_TILE_ID_MAP,
                            None,
                        )
                }
            }
            ...
            pub fn linearized_tile_byte_offset(&self) -> Option<::flatbuffers::Vector<'a, i32>> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, i32>>>(
                            OutputLayout::VT_LINEARIZED_TILE_BYTE_OFFSET,
                            None,
                        )
                }
            }
            ...
            pub fn x_coordinate_to_local_byte_offset(
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, i32>>>(
                            OutputLayout::VT_X_COORDINATE_TO_LOCAL_BYTE_OFFSET,
                            None,
                        )
                }
            }
            ...
            pub fn y_coordinate_to_local_y_offset(&self) -> Option<::flatbuffers::Vector<'a, i32>> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, i32>>>(
                            OutputLayout::VT_Y_COORDINATE_TO_LOCAL_Y_OFFSET,
                            None,
                        )
                }
            }
            ...
            pub fn x_coordinate_to_local_y_row_size(
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, i32>>>(
                            OutputLayout::VT_X_COORDINATE_TO_LOCAL_Y_ROW_SIZE,
                            None,
                        )
                }
            }
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, i32>>>(
                        ...
                        Self::VT_Y_COORDINATE_TO_LINEAR_TILE_ID_MAP,
                        false,
                    )?
                    .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, i32>>>(
                        "x_coordinate_to_linear_tile_id_map",
                        Self::VT_X_COORDINATE_TO_LINEAR_TILE_ID_MAP,
                        false,
                    )?
                    .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, i32>>>(
                        "linearized_tile_byte_offset",
                        Self::VT_LINEARIZED_TILE_BYTE_OFFSET,
                        false,
                    )?
                    .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, i32>>>(
                        "x_coordinate_to_local_byte_offset",
                        Self::VT_X_COORDINATE_TO_LOCAL_BYTE_OFFSET,
                        false,
                    )?
                    .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, i32>>>(
                        "y_coordinate_to_local_y_offset",
                        Self::VT_Y_COORDINATE_TO_LOCAL_Y_OFFSET,
                        false,
                    )?
                    .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, i32>>>(
                        "x_coordinate_to_local_y_row_size",
                        Self::VT_X_COORDINATE_TO_LOCAL_Y_ROW_SIZE,
                        false,
                    )?
                    .finish();
                Ok(())
        ...
        pub struct OutputLayoutBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
            fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
        }
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> OutputLayoutBuilder<'a, 'b, A> {
            #[inline]
            pub fn add_y_coordinate_to_linear_tile_id_map(
                &mut self,
                y_coordinate_to_linear_tile_id_map: ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'b, i32>,
                >,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    OutputLayout::VT_Y_COORDINATE_TO_LINEAR_TILE_ID_MAP,
            ...
            #[inline]
            pub fn add_x_coordinate_to_linear_tile_id_map(
                &mut self,
                x_coordinate_to_linear_tile_id_map: ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'b, i32>,
                >,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            ...
            #[inline]
            pub fn add_linearized_tile_byte_offset(
                &mut self,
                linearized_tile_byte_offset: ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'b, i32>,
                >,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            ...
            #[inline]
            pub fn add_x_coordinate_to_local_byte_offset(
                &mut self,
                x_coordinate_to_local_byte_offset: ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'b, i32>,
                >,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            ...
            #[inline]
            pub fn add_y_coordinate_to_local_y_offset(
                &mut self,
                y_coordinate_to_local_y_offset: ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'b, i32>,
                >,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            ...
            #[inline]
            pub fn add_x_coordinate_to_local_y_row_size(
                &mut self,
                x_coordinate_to_local_y_row_size: ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'b, i32>,
                >,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
        ...
        impl<'a> TensorShape<'a> {
            ...
            pub fn dimension(&self) -> Option<::flatbuffers::Vector<'a, Range>> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, Range>>>(
                            TensorShape::VT_DIMENSION,
                            None,
                        )
                }
            }
     ...
     .finish();
        ...
        impl<'a> Default for TensorShapeArgs<'a> {
            #[inline]
            fn default() -> Self {
                TensorShapeArgs { dimension: None }
            }
        }
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> TensorShapeBuilder<'a, 'b, A> {
            ...
            pub fn add_dimension(
                &mut self,
                dimension: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, Range>>,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    TensorShape::VT_DIMENSION,
                    dimension,
        ...
        impl<'a> TensorLayout<'a> {
            ...
            pub fn shape(&self) -> Option<TensorShape<'a>> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<TensorShape>>(
                            TensorLayout::VT_SHAPE,
                            None,
                        )
                }
            }
        ...
        pub struct TensorLayoutBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
            fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
        }
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> TensorLayoutBuilder<'a, 'b, A> {
            #[inline]
            ...
            pub fn add_stride(
                &mut self,
                stride: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, i32>>,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    TensorLayout::VT_STRIDE,
                    stride,
        ...
        impl<'a> OutputShapeInfo<'a> {
            ...
            >(
                ...
                if let Some(x) = args.slice_offset {
                    builder.add_slice_offset(x);
                }
                if let Some(x) = args.slice_layout {
                    builder.add_slice_layout(x);
                }
                builder.finish()
            }
            ...
            pub fn slice_layout(
                &self,
            ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<TensorLayout<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<TensorLayout>>,
                    >>(OutputShapeInfo::VT_SLICE_LAYOUT, None)
                }
            }
            #[inline]
            pub fn slice_offset(&self) -> Option<::flatbuffers::Vector<'a, i32>> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, i32>>>(
                            OutputShapeInfo::VT_SLICE_OFFSET,
                            None,
                        )
                }
            }
        ...
        impl ::flatbuffers::Verifiable for OutputShapeInfo<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    .visit_field::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<TensorLayout>>,
                    >>("slice_layout", Self::VT_SLICE_LAYOUT, false)?
                    .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, i32>>>(
                        "slice_offset",
                        Self::VT_SLICE_OFFSET,
                        false,
                    )?
                    .finish();
                Ok(())
        ...
        pub struct OutputShapeInfoArgs<'a> {
            pub slice_layout: Option<
                ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<TensorLayout<'a>>>,
                >,
            >,
        ...
        pub struct OutputShapeInfoBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
            fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
        }
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> OutputShapeInfoBuilder<'a, 'b, A> {
            #[inline]
            pub fn add_slice_layout(
                &mut self,
                slice_layout: ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<TensorLayout<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    OutputShapeInfo::VT_SLICE_LAYOUT,
                    slice_layout,
                );
            }
            #[inline]
            pub fn add_slice_offset(
                &mut self,
                slice_offset: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, i32>>,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    OutputShapeInfo::VT_SLICE_OFFSET,
                    slice_offset,
        ...
        impl<'a> NumericsConstants<'a> {
            ...
            pub fn zero_point(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(NumericsConstants::VT_ZERO_POINT, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn dequantization_factor(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(NumericsConstants::VT_DEQUANTIZATION_FACTOR, Some(0.0))
                        .unwrap()
                }
            }
        }
        ...
        pub struct NumericsConstantsBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
            fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
        }
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> NumericsConstantsBuilder<'a, 'b, A> {
            #[inline]
            pub fn add_zero_point(&mut self, zero_point: i32) {
                self.fbb_
                    .push_slot::<i32>(NumericsConstants::VT_ZERO_POINT, zero_point, 0);
            }
            #[inline]
            pub fn add_dequantization_factor(&mut self, dequantization_factor: f32) {
                self.fbb_.push_slot::<f32>(
                    NumericsConstants::VT_DEQUANTIZATION_FACTOR,
                    dequantization_factor,
                    0.0,
                );
            }
            ...
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            ) -> NumericsConstantsBuilder<'a, 'b, A> {
                let start = _fbb.start_table();
        ...
        impl<'a> OutputLayer<'a> {
            ...
            >(
                ...
                if let Some(x) = args.shape_info {
                    builder.add_shape_info(x);
                }
            ...
            pub fn layout(&self) -> Option<OutputLayout<'a>> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<OutputLayout>>(
                            OutputLayer::VT_LAYOUT,
                            None,
                        )
                }
            }
            ...
            pub fn data_type(&self) -> DataType {
                ...
                unsafe {
                    self._tab
                        .get::<DataType>(OutputLayer::VT_DATA_TYPE, Some(DataType::FIXED_POINT8))
                        .unwrap()
                }
            }
            #[inline]
            pub fn shape_info(&self) -> Option<OutputShapeInfo<'a>> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<OutputShapeInfo>>(
                            OutputLayer::VT_SHAPE_INFO,
                            None,
                        )
                }
            }
        ...
        impl ::flatbuffers::Verifiable for OutputLayer<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    .visit_field::<::flatbuffers::ForwardsUOffset<OutputLayout>>(
                        "layout",
                        Self::VT_LAYOUT,
                        false,
                    )?
                    .visit_field::<DataType>("data_type", Self::VT_DATA_TYPE, false)?
                    .visit_field::<::flatbuffers::ForwardsUOffset<OutputShapeInfo>>(
                        "shape_info",
                        Self::VT_SHAPE_INFO,
                        false,
                    )?
        ...
        pub struct OutputLayerBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
            fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
        }
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> OutputLayerBuilder<'a, 'b, A> {
            #[inline]
            pub fn add_layout(&mut self, layout: ::flatbuffers::WIPOffset<OutputLayout<'b>>) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<OutputLayout>>(
                        OutputLayer::VT_LAYOUT,
                        layout,
                    );
            }
            ...
            pub fn add_data_type(&mut self, data_type: DataType) {
                self.fbb_.push_slot::<DataType>(
                    OutputLayer::VT_DATA_TYPE,
                    data_type,
                    DataType::FIXED_POINT8,
                );
            }
            #[inline]
            pub fn add_shape_info(
                &mut self,
                shape_info: ::flatbuffers::WIPOffset<OutputShapeInfo<'b>>,
            ) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<OutputShapeInfo>>(
                        OutputLayer::VT_SHAPE_INFO,
                        shape_info,
                    );
            }
        ...
        pub struct InputLayerBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
            fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
        }
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> InputLayerBuilder<'a, 'b, A> {
            #[inline]
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            ) -> InputLayerBuilder<'a, 'b, A> {
                let start = _fbb.start_table();
                InputLayerBuilder {
                    fbb_: _fbb,
                    start_: start,
        ...
        impl<'a> Layer<'a> {
            ...
            >(
                ...
                if let Some(x) = args.any_layer {
                    builder.add_any_layer(x);
                }
                if let Some(x) = args.numerics {
                    builder.add_numerics(x);
                }
            ...
            pub fn name(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<&str>>(Layer::VT_NAME, None)
                }
            }
            #[inline]
            ...
            pub fn numerics(&self) -> Option<NumericsConstants<'a>> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<NumericsConstants>>(
                            Layer::VT_NUMERICS,
                            None,
                        )
                }
            ...
            pub fn data_type(&self) -> DataType {
                ...
                unsafe {
                    self._tab
                        .get::<DataType>(Layer::VT_DATA_TYPE, Some(DataType::FIXED_POINT8))
                        .unwrap()
                }
            }
            #[inline]
            pub fn any_layer_type(&self) -> AnyLayer {
                ...
                unsafe {
                    self._tab
                        .get::<AnyLayer>(Layer::VT_ANY_LAYER_TYPE, Some(AnyLayer::NONE))
                        .unwrap()
                }
            }
            #[inline]
            ...
            pub fn execution_count_per_inference(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(Layer::VT_EXECUTION_COUNT_PER_INFERENCE, Some(1))
                        .unwrap()
                }
            }
            #[inline]
            pub fn cache_on_dram(&self) -> bool {
                ...
                unsafe {
                    self._tab
                        .get::<bool>(Layer::VT_CACHE_ON_DRAM, Some(false))
                        .unwrap()
                }
            }
            #[inline]
            pub fn shape(&self) -> Option<TensorShape<'a>> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<TensorShape>>(Layer::VT_SHAPE, None)
                }
            }
            #[inline]
            #[allow(non_snake_case)]
     ...
     .finish();
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> LayerBuilder<'a, 'b, A> {
            ...
            pub fn add_name(&mut self, name: ::flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<_>>(Layer::VT_NAME, name);
            }
            #[inline]
            pub fn add_size_bytes(&mut self, size_bytes: i32) {
                self.fbb_
                    .push_slot::<i32>(Layer::VT_SIZE_BYTES, size_bytes, 0);
            }
            #[inline]
            ...
            pub fn add_numerics(
                &mut self,
                numerics: ::flatbuffers::WIPOffset<NumericsConstants<'b>>,
            ) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<NumericsConstants>>(
                        Layer::VT_NUMERICS,
                        numerics,
                    );
            }
            ...
            pub fn add_any_layer_type(&mut self, any_layer_type: AnyLayer) {
                self.fbb_.push_slot::<AnyLayer>(
                    Layer::VT_ANY_LAYER_TYPE,
                    any_layer_type,
                    AnyLayer::NONE,
                );
            }
            #[inline]
            pub fn add_any_layer(
                &mut self,
                any_layer: ::flatbuffers::WIPOffset<::flatbuffers::UnionWIPOffset>,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    Layer::VT_ANY_LAYER,
                    any_layer,
            ...
            #[inline]
            pub fn add_execution_count_per_inference(
                &mut self,
                execution_count_per_inference: i32,
            ) {
                self.fbb_.push_slot::<i32>(
                    Layer::VT_EXECUTION_COUNT_PER_INFERENCE,
            ...
            pub fn add_cache_on_dram(&mut self, cache_on_dram: bool) {
                self.fbb_
                    .push_slot::<bool>(Layer::VT_CACHE_ON_DRAM, cache_on_dram, false);
            }
            #[inline]
            pub fn add_shape(&mut self, shape: ::flatbuffers::WIPOffset<TensorShape<'b>>) {
                self.fbb_
        ...
        impl<'a> Executable<'a> {
            ...
            >(
                ...
                builder
                    .add_used_narrow_memory_bytes_per_tile(args.used_narrow_memory_bytes_per_tile);
                builder.add_estimated_cycles(args.estimated_cycles);
                if let Some(x) = args.chip {
                    builder.add_chip(x);
                }
                if let Some(x) = args.output_layers {
                    builder.add_output_layers(x);
                }
                if let Some(x) = args.input_layers {
                    builder.add_input_layers(x);
                }
                if let Some(x) = args.dma_hints {
                    builder.add_dma_hints(x);
                }
                if let Some(x) = args.parameters {
                    builder.add_parameters(x);
                }
                if let Some(x) = args.instruction_bitstreams {
                    builder.add_instruction_bitstreams(x);
                }
                builder.add_scratch_size_bytes(args.scratch_size_bytes);
                builder.add_batch_size(args.batch_size);
                if let Some(x) = args.serialized_model {
                    builder.add_serialized_model(x);
                }
                if let Some(x) = args.name {
                    builder.add_name(x);
                }
            ...
            pub fn version(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(Executable::VT_VERSION, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn name(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<&str>>(Executable::VT_NAME, None)
                }
            }
            #[inline]
            pub fn serialized_model(&self) -> Option<::flatbuffers::Vector<'a, u8>> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u8>>>(
                            Executable::VT_SERIALIZED_MODEL,
                            None,
                        )
                }
            }
            ...
            pub fn batch_size(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(Executable::VT_BATCH_SIZE, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn scratch_size_bytes(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(Executable::VT_SCRATCH_SIZE_BYTES, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn instruction_bitstreams(
                ...
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<InstructionBitstream<'a>>>,
            > {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<
                            'a,
                            ::flatbuffers::ForwardsUOffset<InstructionBitstream>,
                        >,
                    >>(Executable::VT_INSTRUCTION_BITSTREAMS, None)
                }
            }
            #[inline]
            ...
            pub fn dma_hints(&self) -> Option<DmaHints<'a>> {
                ...
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<::flatbuffers::ForwardsUOffset<DmaHints>>(
                        Executable::VT_DMA_HINTS,
                        None,
                    )
                }
            }
            ...
            pub fn input_layers(
                &self,
            ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Layer<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Layer>>,
                    >>(Executable::VT_INPUT_LAYERS, None)
                }
            }
            #[inline]
            ...
            ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Layer<'a>>>>
            {
                ...
                unsafe {
                    self._tab.get::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Layer>>,
                    >>(Executable::VT_OUTPUT_LAYERS, None)
                }
            }
            #[inline]
            pub fn chip(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<&str>>(Executable::VT_CHIP, None)
                }
            }
            #[inline]
            pub fn estimated_cycles(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(Executable::VT_ESTIMATED_CYCLES, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn used_narrow_memory_bytes_per_tile(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(Executable::VT_USED_NARROW_MEMORY_BYTES_PER_TILE, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn type_(&self) -> ExecutableType {
                ...
                unsafe {
                    self._tab
                        .get::<ExecutableType>(
                            Executable::VT_TYPE_,
                            Some(ExecutableType::STAND_ALONE),
                        )
                        .unwrap()
                }
            }
            ...
            pub fn parameter_caching_token(&self) -> u64 {
                ...
                unsafe {
                    self._tab
                        .get::<u64>(Executable::VT_PARAMETER_CACHING_TOKEN, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn use_tpu_dram_for_parameters(&self) -> bool {
                ...
                unsafe {
                    self._tab
                        .get::<bool>(Executable::VT_USE_TPU_DRAM_FOR_PARAMETERS, Some(false))
                        .unwrap()
                }
            }
            #[inline]
            pub fn estimated_cycles_64bit(&self) -> i64 {
                ...
                unsafe {
                    self._tab
                        .get::<i64>(Executable::VT_ESTIMATED_CYCLES_64BIT, Some(0))
                        .unwrap()
                }
            }
        }
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    ...
                    >>(
                        ...
                        Self::VT_INSTRUCTION_BITSTREAMS,
                        false,
                    )?
                    .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, u8>>>(
                        "parameters",
                    ...
                    .visit_field::<::flatbuffers::ForwardsUOffset<DmaHints>>(
                        "dma_hints",
                        Self::VT_DMA_HINTS,
                        false,
                    )?
                    .visit_field::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<Layer>>,
                    >>("input_layers", Self::VT_INPUT_LAYERS, false)?
                    .visit_field::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<Layer>>,
                    >>("output_layers", Self::VT_OUTPUT_LAYERS, false)?
                    .visit_field::<::flatbuffers::ForwardsUOffset<&str>>(
                        "chip",
                        Self::VT_CHIP,
                        false,
                    ...
                    .visit_field::<i32>(
                        ...
                        Self::VT_USED_NARROW_MEMORY_BYTES_PER_TILE,
                        false,
                    )?
                    .visit_field::<ExecutableType>("type_", Self::VT_TYPE_, false)?
                    .visit_field::<u64>(
                        "parameter_caching_token",
                        Self::VT_PARAMETER_CACHING_TOKEN,
                        false,
                    )?
                    .visit_field::<bool>(
                        "use_tpu_dram_for_parameters",
                        Self::VT_USE_TPU_DRAM_FOR_PARAMETERS,
                        false,
                    )?
                    .visit_field::<i64>(
                        "estimated_cycles_64bit",
                        Self::VT_ESTIMATED_CYCLES_64BIT,
                        false,
                    )?
                    .finish();
                Ok(())
        ...
        pub struct ExecutableArgs<'a> {
            ...
            pub instruction_bitstreams: Option<
                ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<
                        'a,
                        ::flatbuffers::ForwardsUOffset<InstructionBitstream<'a>>,
                    >,
                >,
            >,
            pub parameters: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, u8>>>,
            pub dma_hints: Option<::flatbuffers::WIPOffset<DmaHints<'a>>>,
            pub input_layers: Option<
                ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Layer<'a>>>,
                >,
            >,
            pub output_layers: Option<
                ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Layer<'a>>>,
                >,
            >,
        ...
        pub struct ExecutableBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
            fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
        }
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ExecutableBuilder<'a, 'b, A> {
            #[inline]
            pub fn add_version(&mut self, version: i32) {
                self.fbb_
                    .push_slot::<i32>(Executable::VT_VERSION, version, 0);
            }
            #[inline]
            pub fn add_name(&mut self, name: ::flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<_>>(Executable::VT_NAME, name);
            }
            #[inline]
            pub fn add_serialized_model(
                &mut self,
                serialized_model: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, u8>>,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    Executable::VT_SERIALIZED_MODEL,
                    serialized_model,
            ...
            pub fn add_batch_size(&mut self, batch_size: i32) {
                self.fbb_
                    .push_slot::<i32>(Executable::VT_BATCH_SIZE, batch_size, 0);
            }
            #[inline]
            pub fn add_scratch_size_bytes(&mut self, scratch_size_bytes: i32) {
                self.fbb_.push_slot::<i32>(
                    Executable::VT_SCRATCH_SIZE_BYTES,
                    scratch_size_bytes,
                    0,
                );
            }
            #[inline]
            pub fn add_instruction_bitstreams(
                &mut self,
                instruction_bitstreams: ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<
                        'b,
                        ::flatbuffers::ForwardsUOffset<InstructionBitstream<'b>>,
                    >,
                >,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    Executable::VT_INSTRUCTION_BITSTREAMS,
                    instruction_bitstreams,
                );
            }
            #[inline]
            ...
            pub fn add_dma_hints(&mut self, dma_hints: ::flatbuffers::WIPOffset<DmaHints<'b>>) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<DmaHints>>(
                        Executable::VT_DMA_HINTS,
                        dma_hints,
                    );
            }
            #[inline]
            pub fn add_input_layers(
                &mut self,
                input_layers: ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<Layer<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    Executable::VT_INPUT_LAYERS,
                    input_layers,
                );
            }
            #[inline]
            pub fn add_output_layers(
                &mut self,
                output_layers: ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<Layer<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    Executable::VT_OUTPUT_LAYERS,
                    output_layers,
                );
            }
            #[inline]
            pub fn add_chip(&mut self, chip: ::flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<_>>(Executable::VT_CHIP, chip);
            }
            #[inline]
            pub fn add_estimated_cycles(&mut self, estimated_cycles: i32) {
                self.fbb_
                    .push_slot::<i32>(Executable::VT_ESTIMATED_CYCLES, estimated_cycles, 0);
            }
            #[inline]
            pub fn add_used_narrow_memory_bytes_per_tile(
                &mut self,
                used_narrow_memory_bytes_per_tile: i32,
            ) {
                self.fbb_.push_slot::<i32>(
                    Executable::VT_USED_NARROW_MEMORY_BYTES_PER_TILE,
                    used_narrow_memory_bytes_per_tile,
                    0,
                );
            }
            ...
            pub fn add_type_(&mut self, type_: ExecutableType) {
                self.fbb_.push_slot::<ExecutableType>(
                    Executable::VT_TYPE_,
                    type_,
                    ExecutableType::STAND_ALONE,
                );
            ...
            pub fn add_parameter_caching_token(&mut self, parameter_caching_token: u64) {
                self.fbb_.push_slot::<u64>(
                    Executable::VT_PARAMETER_CACHING_TOKEN,
                    parameter_caching_token,
                    0,
                );
            }
            ...
            pub fn add_use_tpu_dram_for_parameters(&mut self, use_tpu_dram_for_parameters: bool) {
                self.fbb_.push_slot::<bool>(
                    Executable::VT_USE_TPU_DRAM_FOR_PARAMETERS,
                    use_tpu_dram_for_parameters,
                    false,
                );
            }
            ...
            pub fn add_estimated_cycles_64bit(&mut self, estimated_cycles_64bit: i64) {
                self.fbb_.push_slot::<i64>(
                    Executable::VT_ESTIMATED_CYCLES_64BIT,
                    estimated_cycles_64bit,
                    0,
                );
            }
        ...
        impl<'a> MultiExecutable<'a> {
            ...
            >(
                ...
                if let Some(x) = args.serialized_executables {
                    builder.add_serialized_executables(x);
                }
                builder.finish()
            }
            ...
            ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>
            {
                ...
                unsafe {
                    ...
                    >>(MultiExecutable::VT_SERIALIZED_EXECUTABLES, None)
                }
            }
        }
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    ...
                    >>(
                        ...
                        Self::VT_SERIALIZED_EXECUTABLES,
                        false,
                    )?
                    .finish();
                Ok(())
        ...
        pub struct MultiExecutableArgs<'a> {
            pub serialized_executables: Option<
                ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>,
                >,
            >,
        ...
        pub struct MultiExecutableBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
            fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
        }
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> MultiExecutableBuilder<'a, 'b, A> {
            #[inline]
            pub fn add_serialized_executables(
                &mut self,
                serialized_executables: ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<&'b str>>,
                >,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    MultiExecutable::VT_SERIALIZED_EXECUTABLES,
                    serialized_executables,
                );
            }
            #[inline]
        ...
        impl<'a> SerializedPackage<'a> {
            ...
            >(
                ...
                if let Some(x) = args.serialized_package {
                    builder.add_serialized_package(x);
                }
                builder.finish()
            }
            ...
            pub fn serialized_package(&self) -> Option<::flatbuffers::Vector<'a, u8>> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u8>>>(
                            SerializedPackage::VT_SERIALIZED_PACKAGE,
                            None,
                        )
                }
            }
            pub fn serialized_package_nested_flatbuffer(&'a self) -> Option<Package<'a>> {
                self.serialized_package().map(|data| {
                    ...
                    unsafe {
                        <::flatbuffers::ForwardsUOffset<Package<'a>>>::follow(data.bytes(), 0)
                    }
                })
            }
        }
        ...
        pub struct SerializedPackageBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
            fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
        }
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> SerializedPackageBuilder<'a, 'b, A> {
            #[inline]
            pub fn add_serialized_package(
                &mut self,
                serialized_package: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, u8>>,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    SerializedPackage::VT_SERIALIZED_PACKAGE,
                    serialized_package,
            ...
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            ) -> SerializedPackageBuilder<'a, 'b, A> {
                let start = _fbb.start_table();
        ...
        impl<'a> Package<'a> {
            ...
            >(
                ...
                if let Some(x) = args.model_identifier {
                    builder.add_model_identifier(x);
                }
                if let Some(x) = args.multi_chip_package {
                    builder.add_multi_chip_package(x);
                }
                builder.add_virtual_chip_id(args.virtual_chip_id);
                if let Some(x) = args.compiler_version {
                    builder.add_compiler_version(x);
                }
                builder.add_keypair_version(args.keypair_version);
                if let Some(x) = args.signature {
                    builder.add_signature(x);
                }
                if let Some(x) = args.serialized_multi_executable {
                    builder.add_serialized_multi_executable(x);
                }
            ...
            pub fn min_runtime_version(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(Package::VT_MIN_RUNTIME_VERSION, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn serialized_multi_executable(&self) -> Option<::flatbuffers::Vector<'a, u8>> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u8>>>(
                            Package::VT_SERIALIZED_MULTI_EXECUTABLE,
                            None,
                        )
                }
            }
            ...
            pub fn keypair_version(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(Package::VT_KEYPAIR_VERSION, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            ...
            pub fn virtual_chip_id(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(Package::VT_VIRTUAL_CHIP_ID, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn multi_chip_package(
                ...
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<SerializedPackage<'a>>>,
            > {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<
                            'a,
                            ::flatbuffers::ForwardsUOffset<SerializedPackage>,
                        >,
                    >>(Package::VT_MULTI_CHIP_PACKAGE, None)
                }
            }
            #[inline]
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    ...
                    .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, u8>>>(
                        ...
                        Self::VT_SERIALIZED_MULTI_EXECUTABLE,
                        false,
                    )?
                    .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, u8>>>(
                        "signature",
                    ...
                    .visit_field::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<
                            ...
                            ::flatbuffers::ForwardsUOffset<SerializedPackage>,
                        >,
                    >>("multi_chip_package", Self::VT_MULTI_CHIP_PACKAGE, false)?
                    .visit_field::<::flatbuffers::ForwardsUOffset<&str>>(
                        "model_identifier",
                        Self::VT_MODEL_IDENTIFIER,
                        false,
                    )?
                    .finish();
                Ok(())
        ...
        pub struct PackageArgs<'a> {
            ...
            pub multi_chip_package: Option<
                ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<
                        'a,
                        ::flatbuffers::ForwardsUOffset<SerializedPackage<'a>>,
                    >,
                >,
            >,
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> PackageBuilder<'a, 'b, A> {
            ...
            pub fn add_min_runtime_version(&mut self, min_runtime_version: i32) {
                self.fbb_
                    .push_slot::<i32>(Package::VT_MIN_RUNTIME_VERSION, min_runtime_version, 0);
            }
            #[inline]
            pub fn add_serialized_multi_executable(
                &mut self,
                serialized_multi_executable: ::flatbuffers::WIPOffset<
            ...
            pub fn add_keypair_version(&mut self, keypair_version: i32) {
                self.fbb_
                    .push_slot::<i32>(Package::VT_KEYPAIR_VERSION, keypair_version, 0);
            }
            #[inline]
            pub fn add_compiler_version(
                &mut self,
                compiler_version: ::flatbuffers::WIPOffset<&'b str>,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    Package::VT_COMPILER_VERSION,
                    compiler_version,
            ...
            pub fn add_virtual_chip_id(&mut self, virtual_chip_id: i32) {
                self.fbb_
                    .push_slot::<i32>(Package::VT_VIRTUAL_CHIP_ID, virtual_chip_id, 0);
            }
            #[inline]
            pub fn add_multi_chip_package(
                &mut self,
                multi_chip_package: ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<
                        'b,
                        ::flatbuffers::ForwardsUOffset<SerializedPackage<'b>>,
                    >,
                >,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    Package::VT_MULTI_CHIP_PACKAGE,
                    multi_chip_package,
                );
            }
            #[inline]
            pub fn add_model_identifier(
                &mut self,
                model_identifier: ::flatbuffers::WIPOffset<&'b str>,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    Package::VT_MODEL_IDENTIFIER,
                    model_identifier,
        ...
        pub unsafe fn root_as_package_unchecked(buf: &[u8]) -> Package<'_> {
            unsafe { ::flatbuffers::root_unchecked::<Package>(buf) }
        }
        #[inline]
        ...
        pub unsafe fn size_prefixed_root_as_package_unchecked(buf: &[u8]) -> Package<'_> {
            unsafe { ::flatbuffers::size_prefixed_root_unchecked::<Package>(buf) }
        }
        ...
        #[inline]
        pub fn finish_package_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        ...
        #[inline]
        pub fn finish_size_prefixed_package_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
            fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            root: ::flatbuffers::WIPOffset<Package<'a>>,
        ) {
